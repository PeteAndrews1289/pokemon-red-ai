...
| Parallel PPO advances beyond its frozen curriculum | 🟨 Active | E1 | Version 1 stopped at 862,212 actions and Route 1 after exposing episode novelty farming; version 2 persists hash-bound novelty memory per worker and begins fresh from the same 18 verified niches |
